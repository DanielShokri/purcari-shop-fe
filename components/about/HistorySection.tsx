  ...
  return (
    <section className={`${theme.SECTION_PY} bg-gray-50`}>
      <div className={theme.CONTAINER}>
        <div className={`grid grid-cols-1 lg:grid-cols-2 ${theme.GAP_SECTION} items-center`}>
          <motion.div {...fadeInUp}>
            <h2 className={`${theme.H2} mb-6`}>יקב עם היסטוריה מלכותית</h2>
            <div className="w-20 h-1 bg-secondary mb-8"></div>
            <p className={`${theme.BODY_LG} mb-6`}>
