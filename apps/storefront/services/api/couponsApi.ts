...
import { databases, account, functions, APPWRITE_CONFIG } from '@shared/services';
import { Query } from 'appwrite';
import { Coupon, CouponValidationResult, CartItem, CouponDiscountType, CouponUsageRecord } from '@shared/types';
